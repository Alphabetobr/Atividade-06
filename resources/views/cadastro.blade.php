...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="https://travelpedia.com.br/wp-content/uploads/2018/02/cinema-icon.png" id="icon" alt="User Icon"  />
    </div>
    @if ($errors->any())
    ...
    <!-- already logged-->
    <div id="formFooter">
      <a class="underlineHover" href="{{route('login.page')}}">Já está cadastrado? Entre agora!</a>
    </div>
